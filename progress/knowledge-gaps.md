# Knowledge Gaps - Topics Needing More Review

This file tracks topics where you've shown uncertainty or struggled with understanding. These are priority areas for review before the exam on **November 6th, 2025**.

## Format
Each entry should include:
- **Topic**: The specific concept or area
- **Date Identified**: When this gap was discovered
- **Severity**: High/Medium/Low (based on importance for exam)
- **Status**: Not Reviewed / In Progress / Needs More Work / Resolved
- **Notes**: What specifically was challenging
